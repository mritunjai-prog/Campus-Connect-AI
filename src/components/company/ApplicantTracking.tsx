              ...
              >
                  ...
                  <div className="flex flex-wrap gap-2 pt-1 items-center">
                    {app.resumeUrl ? (
                      <a 
                        ...
                        className="inline-flex items-center space-x-1 px-3 py-1.5 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white font-bold text-[10px] transition cursor-pointer"
                      >
                    ...
                    {app.resumeScore > 0 && (
                      <span className="bg-emerald-50 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-800 text-[10px] font-mono px-2.5 py-1 rounded-xl font-bold">
                    ...
                    <div>
                      <div className="flex justify-between items-center pb-2 border-b border-emerald-600/10">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className={`text-[10px] font-mono font-black border text-center px-2 py-0.5 rounded ${hasAiAssessment.recommendation === "Strong" ? "bg-emerald-50 dark:bg-emerald-900/30 border-emerald-250 dark:border-emerald-800 text-emerald-800 dark:text-emerald-400" : (hasAiAssessment.recommendation === "Medium" ? "bg-amber-50 dark:bg-amber-900/30 border-amber-250 dark:border-amber-800 text-amber-800 dark:text-amber-400" : "bg-rose-50 dark:bg-rose-900/30 border-rose-250 dark:border-rose-800 text-rose-800 dark:text-rose-400")}`}>
                ...
                <div className="w-full lg:w-64 border-t lg:border-t-0 lg:border-l border-slate-100 pt-4 lg:pt-0 lg:pl-5 flex flex-col justify-between space-y-3 shrink-0">
                  <div className="space-y-1">
                    ...
                    <span className={`text-[11px] font-black uppercase text-center border px-2.5 py-1 rounded inline-block ${app.status === "selected" ? "bg-emerald-50 dark:bg-emerald-900/30 border-emerald-200 dark:border-emerald-800 text-emerald-800 dark:text-emerald-400" : (app.status === "rejected" ? "bg-rose-50 dark:bg-rose-900/30 border-rose-250 dark:border-rose-800 text-rose-800 dark:text-rose-400" : (app.status === "applied" ? "bg-blue-50 dark:bg-blue-900/30 border-blue-200 dark:border-blue-800 text-blue-800 dark:text-blue-400" : "bg-indigo-50 dark:bg-indigo-900/30 border-indigo-200 dark:border-indigo-800 text-indigo-800 dark:text-indigo-400"))}`}>
                  ...
                  {actionLoadingId === app.id && actionStatusMsg ? (
                    ...
                    <div className="grid grid-cols-2 gap-1.5 text-xs select-none">
                      <button 
                        ...
                        className="bg-slate-50 dark:bg-slate-900/50 hover:bg-slate-100 dark:hover:bg-slate-800 border dark:border-slate-700 text-slate-700 dark:text-slate-200 py-2 rounded-xl text-[11px] font-semibold transition"
                      >
                        Shortlist
                      </button>
                      <button 
                        onClick={() => onScheduleInterview(app.id, app.studentName)}
                        className="bg-amber-50 dark:bg-amber-900/20 hover:bg-amber-100 dark:hover:bg-amber-900/40 border border-amber-200 dark:border-amber-800 text-amber-850 dark:text-amber-400 py-2 rounded-xl text-[11px] font-semibold transition"
                      >
                        Interview
                      </button>
                      <button 
                      ...
                      <button 
                        ...
                        className="bg-rose-50 dark:bg-rose-900/20 hover:bg-rose-100 dark:hover:bg-rose-900/40 border border-rose-150 dark:border-rose-800 text-rose-800 dark:text-rose-400 py-2 rounded-xl text-[11px] font-semibold transition"
                      >
                        Reject Option
                      </button>
                    </div>
